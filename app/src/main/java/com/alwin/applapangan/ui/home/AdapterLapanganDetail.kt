...
class AdapterLapanganDetail(
    val context: Context, val data: MutableList<LapangansItem>,
    private val itemListiner: OnListener
) :
    RecyclerView.Adapter<AdapterLapanganDetail.ViewHolder>(), Filterable {

    var dataFilterList = ArrayList<LapangansItem>()

    init {
        dataFilterList = data as ArrayList<LapangansItem>
    }
    ...
    interface OnListener {
        fun onClickGrup(data: LapangansItem)
    }
    ...
    class ViewHolder(itemView: View) :
        ...
        fun bindView(data: LapangansItem, listiner: OnListener) {
        ...
        return object : Filter() {
            override fun performFiltering(constraint: CharSequence?): FilterResults {
                ...
                if (charSearch.isEmpty()) {
                    ...
                    val resultList = ArrayList<LapangansItem>()
                    for (row in data) {
            ...
            override fun publishResults(constraint: CharSequence?, results: FilterResults?) {
                dataFilterList = results?.values as ArrayList<LapangansItem>
