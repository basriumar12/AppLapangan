...
class AdapterJadwalForBooking2(
    val context: Context, val data: MutableList<JadwalsItem>,
    private val itemListiner: OnListener
) :
    RecyclerView.Adapter<AdapterJadwalForBooking2.ViewHolder>(), Filterable {
    ...
    interface OnListener {
        fun onClickGrupdata(data: JadwalsItem)
    }
