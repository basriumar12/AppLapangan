...
object FilePath {
        ...
        fun getPath(context: Context, uri: Uri): String? {
            ...
            if (isKitKat && DocumentsContract.isDocumentUri(context, uri)) {
                ...
                Log.d("urity", uri.authority.toString())
                if(isGoogleDriveUri(uri)){
                    ...
                    return getDataColumnAHM(context, contentUri, null, null)
...
//                    Log.d("TAG", "getPath: "+docId.replace(":", "/")).toString()
//
//                    Log.d("TAG", "getPath: "+type + "/" + split[1]).toString()

                        "storage/emulated/0/Documents/"+split[1]
...
//                }
        ...
        fun getDataColumnAHM(context: Context, uri: Uri?, selection: String?,
                             selectionArgs: Array<String?>?): String? {
            var cursor: Cursor? = null
            val column = "_data"
    ...
    class LocalStorageProvider : DocumentsProvider() {
        ...
        companion object {
             ...
             */
            private val DEFAULT_ROOT_PROJECTION = arrayOf<String>(DocumentsContract.Root.COLUMN_ROOT_ID, DocumentsContract.Root.COLUMN_FLAGS, DocumentsContract.Root.COLUMN_TITLE, DocumentsContract.Root.COLUMN_DOCUMENT_ID, DocumentsContract.Root.COLUMN_ICON, DocumentsContract.Root.COLUMN_AVAILABLE_BYTES)
            /**
             * Default document projection: everything but Document.COLUMN_ICON and
             * Document.COLUMN_SUMMARY
             */
            private val DEFAULT_DOCUMENT_PROJECTION = arrayOf<String>(DocumentsContract.Document.COLUMN_DOCUMENT_ID, DocumentsContract.Document.COLUMN_DISPLAY_NAME, DocumentsContract.Document.COLUMN_FLAGS, DocumentsContract.Document.COLUMN_MIME_TYPE, DocumentsContract.Document.COLUMN_SIZE, DocumentsContract.Document.COLUMN_LAST_MODIFIED)
        }
